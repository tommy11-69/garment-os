...
async function loadCostingById(id) {
    try {
        ...
        const u = c.uData || {};
        store.update({
            clientName: c.clientId || u.clientName || '',
            ...
            sizes: u.sizes && u.sizes.length ? u.sizes : store.state.sizes,
            gsm: u.gsm || 180,
            fabricPriceKg: u.fabricPriceKg || 0,
            wastage: u.wastage || 5,
            cmtMode: u.cmtMode || 'combined',
            cmt: u.cmt || 0,
            cutting: u.cutting || 0,
            fusing: u.fusing || 0,
            wages: u.wages || 0,
            packing: u.packing || 0,
            printing: u.printing || 0,
            sublimation: u.sublimation || 0,
            acc1: u.acc1 || 0,
            acc2: u.acc2 || 0,
            acc3: u.acc3 || 0,
            pattern: u.pattern || 0,
            allowances: u.allowances || 0,
            overheads: u.overheads || 0,
            profitPct: u.profitPct || 30
        });
