...
CREATE TABLE transactions (
    ...
    createdAt TEXT DEFAULT (datetime('now')),
    updatedAt TEXT DEFAULT (datetime('now'))
, paymentMethod TEXT DEFAULT '', referenceNo TEXT DEFAULT '', notes TEXT DEFAULT '', createdBy TEXT DEFAULT 'Admin');
...
INSERT INTO "transactions" ("_rowid","id","type","amount","date","category","status","description","refId","title","amountColor","isNegative","icon","iconBg","iconColor","linkedBatchId","linkedOrderId","createdAt","updatedAt","paymentMethod","referenceNo","notes","createdBy") VALUES(10,'t-1787256772001','Expense',6000,'2026-08-20','Office Expense','Completed','','','Machine purchase ','',0,'','','','','','2026-08-20T20:12:52.001Z','2026-08-26T06:36:56.045Z','Cash','',replace('Cutting machine -5 k \nScissors - 1000','\n',char(10)),'Admin');
...
INSERT INTO "transactions" ("_rowid","id","type","amount","date","category","status","description","refId","title","amountColor","isNegative","icon","iconBg","iconColor","linkedBatchId","linkedOrderId","createdAt","updatedAt","paymentMethod","referenceNo","notes","createdBy") VALUES(15,'t-1787511542001','Expense',1150,'2026-08-21','Office Expense','Completed','','','Office ','',0,'','','','','','2026-08-23T18:59:02.001Z','2026-08-23T18:59:02.001Z','Bank Transfer','',replace('Wires\nSwatch card','\n',char(10)),'Admin');
...
INSERT INTO "transactions" ("_rowid","id","type","amount","date","category","status","description","refId","title","amountColor","isNegative","icon","iconBg","iconColor","linkedBatchId","linkedOrderId","createdAt","updatedAt","paymentMethod","referenceNo","notes","createdBy") VALUES(28,'t-1787944114740','Expense',870,'2026-08-28','Transport','Completed','','','Milton ','',0,'','','','','','2026-08-28T19:08:34.740Z','2026-08-28T19:08:34.740Z','Bank Transfer','',replace('500-rapido\n270 - parcel','\n',char(10)),'Admin');
...
INSERT INTO "transactions" ("_rowid","id","type","amount","date","category","status","description","refId","title","amountColor","isNegative","icon","iconBg","iconColor","linkedBatchId","linkedOrderId","createdAt","updatedAt","paymentMethod","referenceNo","notes","createdBy") VALUES(30,'t-1787944568550','Expense',437,'2026-08-27','Fabric Purchase','Completed','','','Distn ','',0,'','','','','','2026-08-28T19:16:08.550Z','2026-08-28T19:16:08.550Z','Bank Transfer','',replace('242-Paruthi \n195- Thugil','\n',char(10)),'Admin');
...
INSERT INTO "transactions" ("_rowid","id","type","amount","date","category","status","description","refId","title","amountColor","isNegative","icon","iconBg","iconColor","linkedBatchId","linkedOrderId","createdAt","updatedAt","paymentMethod","referenceNo","notes","createdBy") VALUES(33,'t-1787946740134','Expense',3038,'2026-08-28','Own Expenses','Completed','','','OWN EXPENSES ','',0,'','','','','','2026-08-28T19:52:20.134Z','2026-08-28T19:56:22.000Z','UPI','',replace('Bus - 980 \nPetty selavugal ','\n',char(10)),'Admin');
...
INSERT INTO "transactions" ("_rowid","id","type","amount","date","category","status","description","refId","title","amountColor","isNegative","icon","iconBg","iconColor","linkedBatchId","linkedOrderId","createdAt","updatedAt","paymentMethod","referenceNo","notes","createdBy") VALUES(41,'t-1788285905886','Expense',12000,'2026-09-01','Own Expenses','Completed','','','Banglore expenses ','',0,'','','','','','2026-09-01T18:05:05.886Z','2026-09-03T22:23:09.317Z','UPI','',replace('29,30,31 august \n1 September ','\n',char(10)),'Admin');
...
INSERT INTO "sqlite_sequence" ("name","seq") VALUES('customers',13);
INSERT INTO "sqlite_sequence" ("name","seq") VALUES('costings',14);
INSERT INTO "sqlite_sequence" ("name","seq") VALUES('orders',13);
INSERT INTO "sqlite_sequence" ("name","seq") VALUES('inventory',4);
INSERT INTO "sqlite_sequence" ("name","seq") VALUES('batches',2);
INSERT INTO "sqlite_sequence" ("name","seq") VALUES('quotations',6);
INSERT INTO "sqlite_sequence" ("name","seq") VALUES('transactions',59);
